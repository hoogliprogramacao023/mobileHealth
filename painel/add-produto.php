                                        ...
                                        <div class="row">
                                             <div class="col-md-4">
                                                ...
                                                <label class="mr-sm-2" for="">Valor De</label>
                                                    <input type="text" name="preco_de" class="form-control"  >
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Valor Por</label>
                                                    <input type="text" name="preco_por" class="form-control"  >
                                                </div>
                                            </div>
                                        ...
                                        <div id="divDescricao">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <textarea name="breve" class="ckeditor" id="ckeditor" cols="30" rows="4"></textarea>
                                                </div>
                                            </div>                                        
                                        </div>
                                      <div class="row">
