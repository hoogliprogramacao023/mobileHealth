                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <label class="mr-sm-2" for="">Breve</label>
                                                    <input type="text" class="form-control" name="breve" value="<?php if(isset($editarBanner->breve) && !empty($editarBanner->breve)){ echo $editarBanner->breve;}?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="col-md-3" id="temIcone">
                                                <div class="form-group">
