                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <label class="mr-sm-2" for="">Categoria</label>
                                                    <select name="id_cat" id="" class="form-control">
                                                        ...
                                                        <option value="<?php echo $categoria->id;?>" <?php if(isset($editaServico->id_cat) && $editaServico->id_cat == $categoria->id){ echo "selected";}?>><?php echo $categoria->nome;?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Valor De</label>
                                                    <input type="text" name="preco_de" class="form-control" value="<?php if(isset($editaProduto->preco_de) && !empty($editaProduto->preco_de)){ echo number_format($editaProduto->preco_de,2,',','.');}?>" >
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="mr-sm-2" for="">Valor Por</label>
                                                    <input type="text" name="preco_por" class="form-control" value="<?php if(isset($editaProduto->preco_por) && !empty($editaProduto->preco_por)){ echo number_format($editaProduto->preco_por,2,',','.');}?>" >
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <textarea name="breve" class="ckeditor" id="ckeditor" cols="30" rows="4"><?php if(isset($editaProduto->breve) && !empty($editaProduto->breve)){ echo $editaProduto->breve;}?></textarea>
                                                </div>
                                            </div>                                        
                                        </div>
                                      <div class="row">
