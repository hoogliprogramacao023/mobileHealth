                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $doutor->email;?></td>
                                                <td>
                                                    <a href="editar-especialista.php?id=<?php echo $doutor->id;?>" class="btn btn-success btn-circle">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <a href="especialistas.php?id=<?php echo $doutor->id;?>&acao=excluirDoutor" class="btn btn-warning btn-circle">
